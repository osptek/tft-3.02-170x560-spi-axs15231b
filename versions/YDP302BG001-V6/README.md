...
当前模组版本：**YDP302BG001-V6**。电气与外形细节以 [`docs/YDP302BG001-V6.pdf`](./docs/YDP302BG001-V6.pdf) 为准。
...
| 资料 | 链接 |
| ---- | ---- |
| 产品规格书（YDP302BG001-V6） | [`docs/YDP302BG001-V6.pdf`](./docs/YDP302BG001-V6.pdf) |
